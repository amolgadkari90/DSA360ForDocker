pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE_NAME = "amolgadkari90/dsa360-${DATE_TIME}"
    ...
    stages {
        stage('Get Code') {
            steps {
                ...
                git branch: 'main', url: 'https://github.com/amolgadkari90/DSA360ForDocker.git'
            }
        }
            ...
            steps {
                script {
                    ...
                    existingImages.split('\n').each { img ->
                        if (img.contains("amolgadkari90/dsa360-")) {
            ...
            steps {
                script {
                    ...
                    withCredentials([string(credentialsId: 'dockerpassword', variable: 'dockerpassword')]) {
                        bat "docker login -u amolgadkari90 -p ${dockerpassword}"
